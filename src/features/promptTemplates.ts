...
export class PromptTemplates {
    ...
    private initializeDefaultTemplates(): void {
        ...
        this.addTemplate({
            ...
            template: 'You are an AI programming assistant. Refactor the following code to improve its quality, readability, or performance:\n\n{fileContext}\n\nCode to refactor:\n```\n{selectedCode}\n```\n\nProvide a refactored version with explanations of what you changed and why. Focus on best practices and code quality.'
        });
        ...
        this.addTemplate({
            ...
            template: 'You are an AI programming assistant. Help me with the following programming task:\n\n{question}'
        });
        ...
        this.addTemplate({
            ...
            template: 'You are an AI programming assistant. Help me debug the following issue:\n\n{context}\n\nThe issue I\'m facing is:\n{question}\n\nProvide step-by-step debugging advice and potential solutions.'
        });
        ...
        this.addTemplate({
            ...
            template: 'You are an AI programming assistant. Generate code based on the following requirements:\n\n{context}\n\nRequirements:\n{question}\n\nProvide complete, well-commented code that satisfies these requirements.'
        });
    }
